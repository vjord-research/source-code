function [P,Vbar,delta,gamma,vega,theta]=NCall(V,r,vol,t00,t_i,K_i,p_i,d_i,init,MaxStep,StepSize,GreeksIndic)
...
if strcmp(GreeksIndic,'yes')==1
    ...
    X = ['Price: ',num2str(P),' Delta: ',num2str(delta),' Gamma: ',num2str(gamma),' Vega: ',num2str(vega),' Theta: ',num2str(theta)];
    disp(X);
